...
class WindowAttention(LightningModule):
    ...
    Args:
        ...
        proj_drop (float, optional): Dropout ratio of test_results. Default: 0.0
    """
...
class PatchEmbed(LightningModule):
    ...
    Args:
        ...
        embed_dim (int): Number of linear projection test_results channels. Default: 96.
...
def load_pretrained(config, model, logger):
    ...
    if config.MODEL.TYPE == 'swin':
        ...
        logger.info(f"ViT not yet supported...")
...
def build_ft_model(config, logger):
